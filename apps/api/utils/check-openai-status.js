...
async function checkOpenAIStatus() {
    ...
    try {
        ...
        if (error.message.includes('401')) {
            ...
            console.log("   🔍 This is an authorization error - check your account status");
        }
        return;
    }
    console.log("");
    ...
    for (let i = 1; i <= 3; i++) {
        try {
            ...
            console.log(`   ✅ Success (${endTime - startTime}ms): "${completion.choices[0]?.message?.content}"`);
    ...
    if (successCount === 3) {
        ...
        console.log("   💡 Check the debug-ai-generation.js script for more details");
    } else if (successCount === 0) {
