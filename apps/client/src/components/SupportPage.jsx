          ...
          {supportMethods.map((method, index) => (
            ...
            >
              <div className="p-8 text-center">
                <div className={`mx-auto flex items-center justify-center h-16 w-16 rounded-full ${method.color} ${method.hoverColor} transition-colors duration-200 mb-6`}>
        ...
        >
          <div ref={modalRef} style={contentStyle}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
              <div className={`mx-auto flex items-center justify-center h-20 w-20 rounded-full ${selectedMethod.color} mb-6`}>
