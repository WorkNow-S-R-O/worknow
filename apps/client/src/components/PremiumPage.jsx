...
const PremiumPage = () => {
	...
	const { trackPremiumSubscription, trackButtonClick, trackError } =
		useGoogleAnalytics();
	...
	const getPlans = () => [
		{
			...
			features: [
				{
					text: content.pricingFreeUpTo5Ads.value,
					icon: '📝',
					color: 'text-primary',
				},
				{
					text: content.pricingFreeDailyBoost.value,
					icon: '📈',
					color: 'text-success',
				},
				{
					text: content.pricingFreeBasicSupport.value,
					icon: '💬',
					color: 'text-info',
				},
			],
		...
		},
		{
			...
			features: [
				{
					text: content.pricingProUpTo10Ads.value,
					icon: '📝',
					color: 'text-primary',
				},
				{
					text: content.pricingProUnlimitedSeekerData.value,
					icon: '👥',
					color: 'text-success',
				},
				{
					text: content.pricingProTopJobs.value,
					icon: '⭐',
					color: 'text-warning',
				},
				{
					text: content.pricingProColorHighlighting.value,
					icon: '🎨',
					color: 'text-info',
				},
				{
					text: content.pricingProAdvancedFilters.value,
					icon: '🔍',
					color: 'text-primary',
				},
				{
					text: content.pricingProPrioritySupport.value,
					icon: '🚀',
					color: 'text-danger',
				},
			],
		...
		},
		{
			...
			features: [
				{
					text: content.pricingDeluxeAllFromPro.value,
					icon: '✨',
					color: 'text-warning',
				},
				{
					text: content.pricingDeluxePersonalManager.value,
					icon: '👨‍💼',
					color: 'text-primary',
				},
				{
					text: content.pricingDeluxeFacebookAutoposting.value,
					icon: '⚡',
					color: 'text-info',
				},
				{
					text: content.pricingDeluxeFacebookPromotion.value,
					icon: '📢',
					color: 'text-success',
				},
				{
					text: content.pricingDeluxePersonalMailing.value,
					icon: '📧',
					color: 'text-primary',
				},
				{
					text: content.pricingDeluxeTelegramPublications.value,
					icon: '🔥',
					color: 'text-info',
				},
				{
					text: content.pricingDeluxePersonalCandidateSelection.value,
					icon: '🎯',
					color: 'text-warning',
				},
				{
					text: content.pricingDeluxeInterviewOrganization.value,
					icon: '🤝',
					color: 'text-success',
				},
			],
					...
					{getPlans().map((plan) => {
						...
						return (
							<div className="col-12 col-md-6 col-lg-4 d-flex" key={plan.name}>
								<div
									className={`card flex-fill d-flex flex-column h-100 pricing-card ${plan.highlight ? 'border-primary shadow-lg' : 'shadow-sm'}`}
									style={{
										minWidth: 0,
								...
								>
									<div
										className="card-body d-flex flex-column p-4 h-100"
										style={{
									...
									>
										...
										{plan.highlight && (
											<div className="text-center mb-4">
												<span
													...
													style={{
														fontSize:
															window.innerWidth <= 768 ? '1.1rem' : '0.9rem',
														borderRadius: '12px',
														fontWeight: '700',
														background:
										...
										>
											{plan.name === 'Free'
												? content.pricingFreeTitle.value
												: plan.name}
										</h5>
										...
										<div className="flex-grow-1 d-flex flex-column">
											<ul
												className="list-unstyled mb-5 flex-grow-1"
												style={{
													display: 'flex',
																	...
																	feature.color === 'text-primary'
																		...
																		: feature.color === 'text-success'
																			...
																			: feature.color === 'text-warning'
																				? '#fff3cd'
																				: feature.color === 'text-info'
																					? '#e1f5fe'
																					: feature.color === 'text-danger'
																						? '#ffebee'
																						: '#f5f5f5',
