	...
	const handleChange = (e) => {
		...
		if (name === 'languages') {
			setForm((f) => {
				...
				const nativeLanguage = langs.includes(f.nativeLanguage)
					? f.nativeLanguage
					: '';
					...
					>
							...
							<form onSubmit={handleNext}>
								...
								<div className="mb-3">
									<input
										name="facebook"
										className="form-control"
										placeholder={content.facebookPlaceholder.value}
										value={form.facebook}
										onChange={handleChange}
									/>
								</div>
								<div className="mb-3">
									...
									>
										<option value="">
											{content.locationPlaceholder.value}
										</option>
										{cities.map((city) => (
								...
								<div className="mb-3">
									<textarea
										name="description"
										className="form-control"
										placeholder={content.briefDescriptionPlaceholder.value}
								...
								<div className="mb-3">
									...
									<div className="form-check form-check-inline">
										<input
											...
											id="gender-male"
											value="мужчина"
											checked={form.gender === 'мужчина'}
											onChange={handleChange}
											required
										/>
										<label className="form-check-label" htmlFor="gender-male">
											{content.genderMale.value}
										</label>
									</div>
									<div className="form-check form-check-inline">
										<input
											...
											id="gender-female"
											value="женщина"
											checked={form.gender === 'женщина'}
											onChange={handleChange}
											required
										/>
										<label className="form-check-label" htmlFor="gender-female">
											{content.genderFemale.value}
										</label>
									</div>
								</div>
						...
						{step === 2 && (
							<form onSubmit={handleSubmit}>
								...
								<div className="mb-3">
									<label className="form-label">
										{content.nativeLanguageLabel.value}
									</label>
									<br />
								...
								<div className="mb-3">
									...
									>
										<option value="">
											{content.categoryPlaceholder.value}
										</option>
										{categories.map((cat) => (
								...
								<div className="mb-3">
									...
									>
										<option value="">
											{content.employmentTypePlaceholder.value}
										</option>
								...
								<div className="mb-3">
									...
									>
										<option value="">
											{content.documentTypePlaceholder.value}
										</option>
								...
								<div className="mb-3">
									<textarea
										name="announcement"
										className="form-control"
										placeholder={content.announcementPlaceholder.value}
								...
								<div className="mb-3">
									<textarea
										name="note"
										className="form-control"
										placeholder={content.notePlaceholder.value}
										value={form.note}
										onChange={handleChange}
									/>
								</div>
								...
								<div className="d-flex justify-content-between">
									<button
										...
										onClick={handleBack}
									>
										{content.backButton.value}
									</button>
									<button className="btn btn-success" type="submit">
										{content.saveButton.value}
									</button>
								</div>
							</form>
						)}
