...
const Navbar = () => {
	...
	const { changeLanguage, isLoading, clearLanguagePreference } =
		useLanguageManager();
	...
	useEffect(() => {
		...
		window.testLanguageLoading = () => {
			...
			console.log(
				'LocalStorage value:',
				localStorage.getItem('worknow-language'),
			);
		};
			...
			<div className="d-none d-lg-block mb-10">
				...
				<div className="flex absolute top-0 left-0 m-3 items-center">
					<div className="logo-container">
						<Link
							to="/"
							className="d-flex align-items-center no-underline text-black p-0 m-0"
							style={{ gap: '6px' }}
						>
				...
				<div className="d-flex align-items-center absolute top-0 right-0 m-3">
					...
					<div className="dropdown me-2">
						...
						>
							...
							{locale === 'en'
								? content.languageNames.en.value
								: locale === 'he'
									? content.languageNames.he.value
									: locale === 'ar'
										? content.languageNames.ar.value
										: locale === 'uk'
											? content.languageNames.uk.value
											: content.languageNames.ru.value}
						</button>
