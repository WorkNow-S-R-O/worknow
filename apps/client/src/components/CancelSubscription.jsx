			...
			{!user ? (
				...
				<>
					...
					{isPremium && isAutoRenewal === false && (
						...
						>
							{renewLoading
								? content.enable_loading
								: content.renew_subscription}
						</button>
					)}
					{renewError && (
					...
					{isPremium && isAutoRenewal && (
						<>
							...
							>
								{loading
									? content.cancel_loading
									: content.cancel_subscription_button}
							</button>
							{error && (
