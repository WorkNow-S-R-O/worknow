...
import { JobList, PaginationControl } from '@/components';
			...
			<Helmet>
				...
				<script type="application/ld+json">
					{JSON.stringify({
						...
						'@type': 'JobPosting',
						title: selectedCity.value
							? content.jobPostingTitle.value.replace(
									'{{city}}',
									selectedCity.label,
								)
							: content.jobPostingTitleDefault.value,
						...
						jobLocation: {
							...
							address: {
								'@type': 'PostalAddress',
								addressLocality: selectedCity.value
									? selectedCity.label
									: content.jobLocationDefault.value,
								addressCountry: 'IL',
							},
						},
					})}
