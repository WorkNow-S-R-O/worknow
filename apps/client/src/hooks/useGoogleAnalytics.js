...
export const useGoogleAnalytics = () => {
  ...
  const trackUserRegistration = useCallback((method = 'clerk') => {
    trackEvent('sign_up', {
      method,
  ...
  // Track job creation
  const trackJobCreation = useCallback((jobData = {}) => {
  ...
  const trackPremiumSubscription = useCallback((planData = {}) => {
    trackEvent('purchase', {
  ...
  const trackJobView = useCallback((jobData = {}) => {
    trackEvent('job_view', {
      event_category: 'engagement',
