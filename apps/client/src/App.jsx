...
import { arSA, enUS, heIL, ruRU, ukUA } from '@clerk/localizations';
...
if (!PUBLISHABLE_KEY || !PUBLISHABLE_KEY.startsWith('pk_')) {
	...
	console.error(
		'❌ Ошибка: Некорректный или отсутствует VITE_CLERK_PUBLISHABLE_KEY! Проверьте .env и перезапустите dev-сервер.',
	);
}
				...
				<ImageUploadProvider>
					<HelmetProvider>
						...
						<Helmet>
							...
							<meta
								name="description"
								content="Найти работу в Израиле стало проще! Поиск свежих вакансий в Тель-Авиве, Иерусалиме, Хайфе. Начните карьеру с WorkNow!"
							/>
							<meta
								name="keywords"
								content="работа в Израиле, вакансии в Израиле, поиск работы Израиль, работа Тель-Авив, работа Хайфа"
							/>
							<meta
								property="og:title"
								content="WorkNow – Поиск работы в Израиле"
							/>
							<meta
								property="og:description"
								content="Лучшие вакансии в Израиле. Найдите работу мечты в Тель-Авиве, Иерусалиме, Хайфе и других городах!"
							/>
							...
							<script type="application/ld+json">
								{JSON.stringify({
									...
									potentialAction: {
										'@type': 'SearchAction',
										target:
											'https://worknow.co.il/search?q={search_term_string}',
