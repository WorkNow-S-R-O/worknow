...
const cities = [
	...
	{
		ru: 'Модиин Маккабим Реут',
		he: 'מודיעין מכבים רעות',
		en: 'Modiin Maccabim Reut',
		ar: 'موديعين مكابيم رعوت',
	},
	{
		ru: 'Мигдаль Ха-Эмек',
		he: 'מגדל העמק',
...
async function main() {
	...
	for (const seeker of testSeekers) {
		await prisma.seeker.create({
			data: { ...seeker, slug: generateSlug(seeker.name, seeker.description) },
		});
	}
