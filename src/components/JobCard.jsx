    ...
    >
      ...
      {job.user?.imageUrl && (
        <div
          ...
          style={{ width: '45px', height: '45px', cursor: 'pointer', borderRadius: '50%', overflow: 'hidden', backgroundColor: '#f0f0f0' }}
          onClick={handleAvatarClick}
        >
          {imageLoading && <Spinner animation="border" variant="primary" size="sm" />}
          <img
