...
async function testFallbackOnly() {
    ...
    console.log("📊 This will test the rule-based title generation without OpenAI\n");
    ...
    console.log(`📝 Testing ${testDescriptions.length} descriptions with fallback system...\n`);
