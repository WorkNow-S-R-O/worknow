...
async function testJobLimits() {
	...
	try {
		...
		console.log(`\n✅ Test Results:`);
		console.log(
			`   Free User (5 jobs): ${testFreeUser.isPremium || testFreeUser.premiumDeluxe ? MAX_JOBS_PREMIUM_USER : MAX_JOBS_FREE_USER}`,
		);
		console.log(
			`   Premium User (10 jobs): ${testPremiumUser.isPremium || testPremiumUser.premiumDeluxe ? MAX_JOBS_PREMIUM_USER : MAX_JOBS_FREE_USER}`,
		);
		console.log(
			`   Deluxe User (10 jobs): ${testDeluxeUser.isPremium || testDeluxeUser.premiumDeluxe ? MAX_JOBS_PREMIUM_USER : MAX_JOBS_FREE_USER}`,
		);
