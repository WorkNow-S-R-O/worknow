...
async function testButtonText() {
  ...
  try {
    ...
    console.log('   Status:', check1.data.isSubscribed ? 'Subscribed' : 'Not subscribed');
    ...
    console.log('   Status:', check2.data.isSubscribed ? 'Subscribed' : 'Not subscribed');
    ...
    console.log('✅ Button should show: "Сбросить" (Reset)');
    console.log('   Status:', check3.data.isSubscribed ? 'Subscribed' : 'Not subscribed');
