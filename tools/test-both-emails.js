...
import { sendProWelcomeEmail, sendPremiumDeluxeWelcomeEmail } from '../apps/api/services/premiumEmailService.js';
...
async function testBothEmails() {
  ...
  try {
    ...
    const deluxeResult = await sendPremiumDeluxeWelcomeEmail(testEmail, testUserName);
