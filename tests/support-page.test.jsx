...
vi.mock('react-intlayer', () => ({
    useIntlayer: () => ({
        ...
        support_hero_description: 'We are here to help you with any questions or issues.',
        support_get_in_touch: 'Get in Touch',
        support_get_in_touch_description: 'Choose your preferred method of contact.',
        support_email_title: 'Email Support',
        support_email_description: 'Send us an email and we will respond within 24 hours.',
        ...
        support_community_driven_description: 'Built by the community, for the community.',
        ...
        support_faq_create_job_answer: 'Click on "Create New Advertisement" and fill out the form.',
        support_faq_premium_question: 'What are premium features?',
        support_faq_premium_answer: 'Premium features include job boosting and extended statistics.',
        support_faq_edit_job_question: 'How do I edit my job posting?',
        support_faq_edit_job_answer: 'Go to "My Advertisements" and click edit on your job.',
        support_faq_contact_seekers_question: 'How do I contact job seekers?',
        support_faq_contact_seekers_answer: 'Use the contact information provided in their profiles.',
        support_faq_job_limits_question: 'How many jobs can I post?',
        support_faq_job_limits_answer: 'Free users can post up to 3 jobs, premium users have unlimited posts.',
        support_faq_payment_question: 'How do I pay for premium?',
        support_faq_payment_answer: 'We accept all major credit cards through Stripe.',
        support_faq_categories_question: 'How do I choose job categories?',
        support_faq_categories_answer: 'Select the most relevant category for your job posting.',
...
describe('SupportPage Component', () => {
    ...
    describe('Rendering', () => {
        test('renders the main support page structure', () => {
            ...
            expect(screen.getByText('We are here to help you with any questions or issues.')).toBeInTheDocument();
        ...
        test('renders all FAQ items', () => {
            ...
            expect(screen.getByText('How do I create a job posting?')).toBeInTheDocument();
            expect(screen.getByText('What are premium features?')).toBeInTheDocument();
            expect(screen.getByText('How do I edit my job posting?')).toBeInTheDocument();
        });
        ...
        test('renders support hours section', () => {
            ...
            expect(screen.getByText('Saturday - Sunday: 10:00 AM - 4:00 PM')).toBeInTheDocument();
        });
    });
    ...
    describe('Support Methods', () => {
        test('displays correct contact information for each method', () => {
            ...
            expect(screen.getByText('worknow.notifications@gmail.com')).toBeInTheDocument();
    ...
    describe('Desktop Behavior', () => {
        test('opens email client when email contact button is clicked', async () => {
            ...
            expect(mockWindowOpen).toHaveBeenCalledWith('mailto:worknow.notifications@gmail.com', '_blank');
        });
        ...
        test('opens phone dialer when phone contact button is clicked', async () => {
            ...
            expect(mockWindowOpen).toHaveBeenCalledWith('tel:+972-053-3033332', '_blank');
        });
    ...
    describe('Mobile Behavior', () => {
        ...
        test('opens modal when contact button is clicked on mobile', async () => {
            ...
            const emailElements = screen.getAllByText('worknow.notifications@gmail.com');
        ...
        test('closes modal when contact link is clicked', async () => {
            ...
            const modalContactButton = modalContactButtons[modalContactButtons.length - 1]; // Last one is in modal
    ...
    describe('Touch Events (Mobile)', () => {
        ...
        test('modal has touch event handlers attached', () => {
            ...
            const modalContainer = document.querySelector('[style*="position: fixed"]');
    ...
    describe('Responsive Design', () => {
        test('applies correct classes for desktop layout', () => {
            ...
            const supportMethodsGrid = document.querySelector('.grid.md\\:grid-cols-3');
