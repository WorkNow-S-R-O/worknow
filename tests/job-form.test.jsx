...
vi.mock('../apps/client/src/components/form/JobFormFields', () => ({
	default: ({ register, errors, setValue, onImageUpload, isSubmitting }) => (
		<div data-testid="job-form-fields">
			...
			/>
			{errors.title && (
				<span data-testid="title-error">{errors.title.message}</span>
			)}
			...
			/>
			{errors.salary && (
				<span data-testid="salary-error">{errors.salary.message}</span>
			)}
			...
			{errors.cityId && (
				<span data-testid="city-error">{errors.cityId.message}</span>
			)}
			...
			{errors.categoryId && (
				<span data-testid="category-error">{errors.categoryId.message}</span>
			)}
			...
			/>
			{errors.phone && (
				<span data-testid="phone-error">{errors.phone.message}</span>
			)}
			...
			<button
				...
				onClick={() =>
					onImageUpload('test-image-url', new File([''], 'test.jpg'))
				}
			>
				Upload Image
			</button>
